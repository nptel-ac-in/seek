...
class CustomUnit(object):
    ...
    def __init__(self, identifier, name, rest_handler_cls, visible_url_fn,
		 ...
		 import_helper=None, is_graded=False, i18n_resource_key_fn=None):
        self.name = name
    ...
    def import_unit(self, src_course, src_unit, dst_course, dst_unit):
        if self.import_helper:
            self.import_helper(src_course, src_unit, dst_course, dst_unit)
