...
class _Library(object):
    ...
    def __init__(self, zipfile, lib_path='lib', relative_path=None):
    ...
    def file_path(self):
        ...
        return os.path.join(BUNDLE_ROOT, self._lib_path, self._zipfile)
...
THIRD_PARTY_LIBS = [
    ...
    _Library('httpagentparser-1.6.0.zip', relative_path='httpagentparser-1.6.0'),
    _Library('networkx-1.9.1.zip', relative_path='networkx-1.9.1'),
    _Library('decorator-3.4.0.zip', relative_path='src'),
