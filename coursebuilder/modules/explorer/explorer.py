...
from modules.explorer import student
...
def register_module():
    ...
    custom_module = custom_modules.Module(
        ...
        handlers.global_routes + settings.global_routes + student.global_routes,
        handlers.namespaced_routes + settings.namespaced_routes + student.namespaced_routes)
