...
COURSE_FEATURED_DESCRIPTION = """
When checked, this course will show up as "Featured" in the explorer and show
...
This Youtube Video content is displayed at right hand side of the Extra Content
block. You'll need to provide the embed url of the video.
"""

EXPLORER_SUMMARY_DESCRIPTION = """
A short summary which will be displayed on the explorer page (if "Show in
Explorer" is checked).
"""

EXPLORER_INSTRUCTOR_NAME_DESCRIPTION = """
Name of the instructor which will be displayed on the explore page (if "Show in
Explorer" is checked).
"""

TAGS_DESCRIPTION = """
Tags (Comma separated words or phrases) by which the user can search for this
course on the explorer page.
"""
