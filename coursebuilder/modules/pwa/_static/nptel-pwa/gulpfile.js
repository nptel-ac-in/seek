...
gulp.task('jshint', function() {
  return gulp.src(['assets/**/*.js', 'app/styleguide/**/*.js'])
...
gulp.task('serve', ['styles'], function() {
  ...
  gulp.watch(['assets/js/**/*.js','app/styleguide/**/*.js'], ['jshint']);
...
gulp.task('generate-service-worker', function(callback) {
  ...
  swPrecache.write('sw.js', {
    ...
    stripPrefix: '.',
    // runtimeCaching : [{
    //   urlPattern: /^https:\/\/beta-dot-nptelmooc2013\.appspot\.com\/m\//,
