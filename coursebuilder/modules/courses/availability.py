        ...
        for unit_order in children_order:
            for unit in course.get_units():
                if unit_order['id'] == unit.unit_id:
                    if course.get_parent_unit(unit.unit_id) or not unit.is_unit():
                        continue
                    ...
                    for child in unit_order["children"]:
                        ...
                        if child["section"] == 'sub_unit':
                            ...
                            if sub_unit:
                                cls.add_unit(sub_unit,elements, indent=True)
                    break
        return elements
        ...
        for item in payload.get(cls.ELEMENT_SETTINGS, []):
            ...
            if element:
                if cls.AVAILABILITY_FIELD in item:
                    ...
                    if element.availability != courses.AVAILABILITY_UNAVAILABLE:
