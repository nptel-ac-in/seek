...
LIS_PERSON_SOURCED_ID = 'lis_person_sourced_id'
LIS_PERSON_SOURCEDID = 'lis_person_sourcedid'
LIS_COURCE_OFFERING_SOURCEDID = 'lis_course_offering_sourcedid'
...
EXT_IMS_LIS_RESULTVALUE_SOURCEDIDS = 'ext_ims_lis_resultvalue_sourcedids'
EXT_IMS_LIS_MEMBERSHIPS_URL = 'ext_ims_lis_memberships_url'
EXT_IMS_LIS_MEMBERSHIPS_ID = 'ext_ims_lis_memberships_id'
EXT_IMS_LTI_TOOL_SETTING_URL = 'ext_ims_lti_tool_setting_url'
EXT_IMS_LTI_TOOL_SETTING_ID = 'ext_ims_lti_tool_setting_id'
CUSTOM_TC_PROFILE_URL = 'custom_tc_profile_url'
CUSTOM_SYSTEM_SETTING_URL = 'custom_system_setting_url'
CUSTOM_CONTEXT_SETTING_URL = 'custom_context_setting_url'
CUSTOM_LINK_SETTING_URL = 'custom_link_setting_url'
CUSTOM_LINEITEMS_URL = 'custom_lineitems_url'
CUSTOM_RESULTS_URL = 'custom_results_url'
CUSTOM_LINEITEM_URL = 'custom_lineitem_url'
CUSTOM_RESULT_URL = 'custom_result_url'
CUSTOM_CONTEXT_MEMBERSHIPS_URL = 'custom_context_memberships_url'
CUSTOM_LINK_MEMBERSHIPS_URL = 'custom_link_memberships_url'
